...
export default function App(){
    ...
    const numBook = [
         ['','هزار', 'میلیون', 'میلیارد', 'بیلیون', 'بیلیارد', 'تریلیون', 'تریلیارد','کوآدریلیون','کادریلیارد','کوینتیلیون','کوانتینیارد','سکستیلیون','سکستیلیارد','سپتیلیون','سپتیلیارد','اکتیلیون','اکتیلیارد','نانیلیون','نانیلیارد','دسیلیون','دسیلیارد','آندسیلیون','آندسیلیارد','دودسیلیون','دودسیلیارد','تریدسیلیون','تریدسیلیارد','کوادردسیلیون','کوادردسیلیارد','کویندسیلیون','کویندسیلیارد','سیدسیلیون','سیدسیلیارد'],
